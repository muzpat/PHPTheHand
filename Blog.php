            ...
            <div class="col-md-6">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    <div class="card-body d-flex flex-column align-items-start">
                        <strong class="d-inline-block mb-2 text-primary">World of Hair</strong>
                        <h3 class="mb-0">
                            <a class="text-dark" href="#">Featured post</a>
                        </h3>
                        <div class="mb-1 text-muted">Aug 12</div>
                        <p class="card-text mb-auto">A Number #1 please</p>
            ...
            <div class="col-md-6">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    <div class="card-body d-flex flex-column align-items-start">
                        ...
                        <h3 class="mb-0">
                            <a class="text-dark" href="#">Salon</a>
                        </h3>
                        <div class="mb-1 text-muted">Aug 21</div>
                        <p class="card-text mb-auto">What's happened to our loos?</p>
                        <a href="#">Continue reading</a>
                    </div>
                    <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Card image cap" />
                </div>
        ...
        <div class="row">
            <div class="col-md-8 blog-main">
                <h3 class="pb-3 mb-4 font-italic border-bottom">
                    From the Clipping Front
                </h3>

                <div class="blog-post">
                    <h2 class="blog-post-title">Wigged Out About Brexit</h2>
                    <p class="blog-post-meta">
                        September 1, 2019 by
                        <a href="#">Mark</a>
                    </p>

                    <p>This blog post rocks!</p>
                    <hr />
                    <p>
