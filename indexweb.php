            ...
            <header class="header">
                ...
                <div>
                    <nav class="my-2 my-md-0 mr-md-3">
                                      <button id="webtoggle"   onclick="window.location.href = 'Index1.php'">Mobilex</button>
                                      <button id="webtoggle"   onclick="window.location.href = 'payments.php'">Payments</button>
