    ...
    <div class="container">
        <div class="card-deck mb-3 text-center">
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    <h2 class="card-title pricing-card-title"><small class="text-muted">On-Site Massage&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</small></h2>
            ...
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    <h2 class="card-title pricing-card-title"><small class="text-muted">Therapeutic Massage</small></h2>
            ...
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    <h2 class="card-title pricing-card-title"><small class="text-muted">Costings</small></h2>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md">
                    ...
                    <ul class="list-unstyled text-small">
                        <li><a class="text-muted" onclick="Contact();" href="#">Contact</a></li>
                ...
                <div class="col-6 col-md">
                    <h5>References</h5>
                    <ul class="list-unstyled text-small">
                        <li><a class="text-muted" onclick="window.location.href = 'Testimonials.php';" href="#">Testimonials</a></li>
                ...
                <div class="col-6 col-md">
                    <h5>Jobs</h5>
                    <ul class="list-unstyled text-small">
                        <li><a class="text-muted" onclick="recruitment(this)" href="#">Recruitment</a></li>
                ...
                <div class="col-6 col-md">
                    <h5>About</h5>
                    <ul class="list-unstyled text-small">
                        <li><a class="text-muted" onclick="about(this)" href="#">About</a></li>
    ...
    <div id="loviz" class="popup">
        ...
        <script type="text/javascript">
            ...
            function whichuser(e) {
                var myLine = '<div><h6>Stylist: <br/> <select><option value = "1">Tina Sparkle</option></select></h6></div>';
                alert(myLine);
