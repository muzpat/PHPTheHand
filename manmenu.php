            ...
            <header class="header">
                ...
                <div>
                    <nav class="my-2 my-md-0 mr-md-3">
                        ...
                        <a class="p-2 text-dark" onclick="whoamI(this)" style="font-size:x-large" href="#">Massage Therapist's Page</a>

                        <a class="p-2 text-dark" style="font-size:x-large" href="Management.php">All Bookings</a>
                        <a class="p-2 text-dark" style="font-size:x-large" href="Blog.php">Blog</a>
                        <a class="p-2 text-dark" style="font-size:x-large" onclick="whichuser(this)" href="#">Users</a>
                    </nav>
                </div>
